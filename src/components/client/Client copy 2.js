...
function Client({ isReservation, onSelectClient }) {
  ...
  return (
    <div>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          {/* Asegurarnos de que estamos pasando isReservation correctamente */}
          <ClientList
            onEditClient={handleEditClient}
            clientsUpdated={clientsUpdated}
            setClientsUpdated={setClientsUpdated}
            isReservation={isReservation}
            onSelectClient={onSelectClient}  // Pasamos la función para seleccionar cliente
          />
        </AccordionDetails>
      </Accordion>
    </div>
