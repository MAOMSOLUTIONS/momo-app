...
import formFields from './formFieldsCustomer';
import DynamicFormFields from '../dinamico/DynamicFormFields';

import axios from 'axios';
import { format, parse } from 'date-fns';
const BasicDataAssetForm = ({ onUserUpdated,initialValues, setSelectedUser, isFieldsEnabled, onClear  }) => {
...
//          handleClearFields();
  ...
  const getAccordionLabel = () => {
    return isCreating ? 'Crear Factor' : 'Modificar Factor';
  };
