      ...
      <ListItem button onClick={() => handleSubMenuClick('Catálogos')} className="drawerStyle">
        ...
        {openSubMenu === 'Catálogos' && (
          <List>
            ...
            <ListItem button onClick={() => handleMenuItemSelect('Propiedades')}>
              <ListItemText primary={t('- Propiedades')} className="listItemStyle" />
            </ListItem>
            <ListItem button onClick={() => handleMenuItemSelect('Mini Bodegas')}>
              <ListItemText primary={t('- Mini Bodegas')} className="listItemStyle" />
            </ListItem>
            <ListItem button onClick={() => handleMenuItemSelect('Usuarios')}>
              <ListItemText primary={t('- Usuarios')} className="listItemStyle" />
            </ListItem>
            <ListItem button onClick={() => handleMenuItemSelect('Documentos')}>
              <ListItemText primary={t('- Documentos')} className="listItemStyle" />
            </ListItem>
          </List>
        )}      
    ...
    <div>
      <AppBar position="static">
        <Toolbar className="menuStyle">
          ...
          <Button onClick={() => handleMenuItemClick('Mini Bodegas')} className="buttonStyle">{t('Mini Bodegas')}</Button>
          <Button onClick={() => handleMenuItemClick('Reserva')} className="buttonStyle">{t('Reserva')}</Button>
          <Button onClick={() => handleMenuItemClick('Clientes')} className="buttonStyle">{t('Clientes')}</Button>
          <Button onClick={() => handleMenuItemClick('Facturas')} className="buttonStyle">{t('Facturas')}</Button>
