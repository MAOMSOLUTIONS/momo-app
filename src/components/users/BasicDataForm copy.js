...
const BasicDataForm = ({ initialValues, setSelectedUser, isFieldsEnabled, onClear  }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = isCreating ? 'http://127.0.0.1:5000/api/users' : `http://127.0.0.1:5000/api/users/${formValues.id}`;
