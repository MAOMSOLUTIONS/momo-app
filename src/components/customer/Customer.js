...
import CreateEnterpriseForm from './CreateCustomerForm';
import EnterpriseList from './CustomerList';
import BasicDataEnterpriseForm from './BasicDataCustomerForm';
    ...
    <div>
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>{t('Consulta de Cliente')}</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion expanded={isCreateAccordionOpen} onChange={() => setIsCreateAccordionOpen(!isCreateAccordionOpen)}>
        <AccordionSummary expandIcon={<ExpandMoreIcon />} ref={modifyUserRef}>
          <Typography>{!selectedUser ? t("Crear Cliente") : t("Modificar Cliente")}</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <div style={{ width: '100%' }}>
            {selectedUser !== null ? (
